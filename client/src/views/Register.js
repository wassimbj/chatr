                                ...
                                <div className='container mx-auto'>
                                    <div className="bg-white shadow-md border-2 border-gray-300 rounded mx-auto w-full lg:w-1/2 md:w-2/3 px-8 pt-6 pb-8 mb-4 flex flex-col mt-20">
                                        <div className='mb-5 p-3'>
                                            ...
                                            <h1 className='text-center font-bold text-2xl'> Create an account on chatr </h1>
                                        </div>
                                        ...
                                        <div className='flex flex-wrap -mx-3 mb-6'>
                                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                                <label className="block text-gray-600 text-sm font-bold mb-2">firstname</label>
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker"
                                                    onChange={this.handleChange('firstname')} type="text" placeholder="e.g: joe" />
                                            </div>
                                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                                <label className="block text-gray-600 text-sm font-bold mb-2">lastname</label>
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker"
                                        ...
                                        <a href='/login' className='block text-sm text-center text-blue-500 mt-3'> Already have an account ? Login </a>
